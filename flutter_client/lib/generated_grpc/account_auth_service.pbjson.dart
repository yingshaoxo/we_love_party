...
const RegisterResponse$json = const {
  '1': 'RegisterResponse',
  '2': const [
    const {'1': 'the_email_the_user_need_to_send_verify_code_to', '3': 1, '4': 1, '5': 9, '10': 'theEmailTheUserNeedToSendVerifyCodeTo'},
    const {'1': 'the_verify_code_the_user_need_to_send_back', '3': 2, '4': 1, '5': 9, '10': 'theVerifyCodeTheUserNeedToSendBack'},
...
final $typed_data.Uint8List registerResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List registerConfirmRequestDescriptor = $convert.base64Decode('ChZSZWdpc3RlckNvbmZpcm1SZXF1ZXN0EhQKBWVtYWlsGAEgASgJUgVlbWFpbBJWCip0aGVfdmVyaWZ5X2NvZGVfdGhlX3VzZXJfbmVlZF90b19zZW5kX2JhY2sYAiABKAlSInRoZVZlcmlmeUNvZGVUaGVVc2VyTmVlZFRvU2VuZEJhY2s=');
@$core.Deprecated('Use registerConfirmResponseDescriptor instead')
const RegisterConfirmResponse$json = const {
  '1': 'RegisterConfirmResponse',
  '2': const [
...
/// Descriptor for `RegisterConfirmResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List registerConfirmResponseDescriptor = $convert.base64Decode('ChdSZWdpc3RlckNvbmZpcm1SZXNwb25zZRIQCgNqd3QYASABKAlSA2p3dBIZCgVlcnJvchgCIAEoCUgAUgVlcnJvcogBAUIICgZfZXJyb3I=');
