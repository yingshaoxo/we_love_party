...
class RegisterResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisterResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'account_auth_service'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'theEmailTheUserNeedToSendVerifyCodeTo')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'theVerifyCodeTheUserNeedToSendBack')
  ...
  factory RegisterResponse({
    $core.String? theEmailTheUserNeedToSendVerifyCodeTo,
    $core.String? theVerifyCodeTheUserNeedToSendBack,
    $core.String? error,
  }) {
    final _result = create();
    if (theEmailTheUserNeedToSendVerifyCodeTo != null) {
      _result.theEmailTheUserNeedToSendVerifyCodeTo = theEmailTheUserNeedToSendVerifyCodeTo;
    }
    if (theVerifyCodeTheUserNeedToSendBack != null) {
      _result.theVerifyCodeTheUserNeedToSendBack = theVerifyCodeTheUserNeedToSendBack;
    }
    if (error != null) {
      _result.error = error;
    }
  ...
  @$pb.TagNumber(1)
  $core.String get theEmailTheUserNeedToSendVerifyCodeTo => $_getSZ(0);
  @$pb.TagNumber(1)
  set theEmailTheUserNeedToSendVerifyCodeTo($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasTheEmailTheUserNeedToSendVerifyCodeTo() => $_has(0);
  @$pb.TagNumber(1)
  void clearTheEmailTheUserNeedToSendVerifyCodeTo() => clearField(1);

  @$pb.TagNumber(2)
  $core.String get theVerifyCodeTheUserNeedToSendBack => $_getSZ(1);
  @$pb.TagNumber(2)
  set theVerifyCodeTheUserNeedToSendBack($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasTheVerifyCodeTheUserNeedToSendBack() => $_has(1);
  @$pb.TagNumber(2)
  void clearTheVerifyCodeTheUserNeedToSendBack() => clearField(2);
...
class RegisterConfirmResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisterConfirmResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'account_auth_service'), createEmptyInstance: create)
  ...
  RegisterConfirmResponse._() : super();
  factory RegisterConfirmResponse({
    $core.String? jwt,
    $core.String? error,
  }) {
    final _result = create();
  ...
  factory RegisterConfirmResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RegisterConfirmResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RegisterConfirmResponse clone() => RegisterConfirmResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegisterConfirmResponse copyWith(void Function(RegisterConfirmResponse) updates) => super.copyWith((message) => updates(message as RegisterConfirmResponse)) as RegisterConfirmResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RegisterConfirmResponse create() => RegisterConfirmResponse._();
  RegisterConfirmResponse createEmptyInstance() => create();
  static $pb.PbList<RegisterConfirmResponse> createRepeated() => $pb.PbList<RegisterConfirmResponse>();
  @$core.pragma('dart2js:noInline')
  static RegisterConfirmResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RegisterConfirmResponse>(create);
  static RegisterConfirmResponse? _defaultInstance;
